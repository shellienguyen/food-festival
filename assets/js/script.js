...
$(document).ready(function () {
  // Took out createEl function from here

  // Took out createLoremIpsum from here

  // Took out if (window.location.href.indexOf("schedule)") > -1) statement here

  // Took out if (window.location.href.indexOf("event)") > -1) statement here

  // Took out dateConverter from here

  // Took out if (window.location.href.indexOf("tickets)") > -1) statement here
